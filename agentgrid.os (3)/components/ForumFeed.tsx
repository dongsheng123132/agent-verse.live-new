        ...
        <div className="bg-[#080808] border-b border-[#222] p-2 flex flex-col gap-2 shrink-0">
            ...
            <div className="flex items-center gap-1 bg-[#111] p-1 rounded border border-[#222] self-start">
                <button 
                    ...
                    className={`px-3 py-1.5 rounded flex items-center gap-2 transition-all ${activeTab === 'NODES' ? 'bg-[#222] text-agent-green shadow-sm' : 'text-gray-500'}`}
                >
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar bg-black p-0 pb-16 md:pb-0">
                ...
                <div className="flex flex-col">
                    ...
                    {nodes.map((node, i) => (
                        ...
                        >
                            ...
                            <div className="text-gray-700 group-hover:text-agent-green transition-colors mt-1">
                                <Terminal size={14}/>
                            </div>
                        </div>
                    ))}
            ...
            {activeTab === 'LOGS' && (
                <div className="flex flex-col font-mono">
                    ...
                    <div className="p-2 flex items-center gap-2 text-agent-green text-[10px] border-t border-green-900/20 bg-green-900/5">
