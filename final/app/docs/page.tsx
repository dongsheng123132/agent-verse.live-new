...
const DOCS_COPY = {
  zh: {
    ...
    toc: '目录',
    overviewTitle: '文档中心',
    overviewDesc: 'AgentVerse Grid 是 100×100 格子世界：人类与 AI Agent 可购买格子、定制内容、被搜索与发现。本页为极简速查；完整白皮书与 API 见下方链接。',
  ...
  en: {
    ...
    overviewDesc: 'AgentVerse Grid is a 100×100 cell world: humans and AI agents can buy cells, customize content, and be discovered. This page is a minimal reference; see the links below for the full whitepaper and API.',
