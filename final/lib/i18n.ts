...
const dict = {
  ...
  'recover_desc': { en: 'Lost your key? Enter cell coordinates and your wallet address to regenerate.', zh: '丢失了 Key？输入格子坐标和你的钱包地址重新生成。' },
  'owner_placeholder': { en: 'Wallet address (0x...)', zh: '钱包地址 (0x...)' },
  'regenerate': { en: 'Regenerate Key', zh: '重新生成 Key' },
  'regenerating': { en: 'Regenerating...', zh: '生成中...' },
  'copy_key': { en: 'Copy Key', zh: '复制 Key' },
