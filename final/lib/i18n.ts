...
const dict = {
  ...
  'recover_desc': { en: 'Lost your key? Pay 0.01 USDC via x402 to prove wallet ownership and regenerate.', zh: '丢失了 Key？通过 x402 支付 0.01 USDC 证明钱包所有权并重新生成。' },
  'recover_cmd_label': { en: 'Recovery Command', zh: '恢复命令' },
  'recover_cost': { en: 'Cost: 0.01 USDC on Base. Payment proves wallet ownership.', zh: '费用：0.01 USDC (Base)。支付即证明钱包所有权。' },
