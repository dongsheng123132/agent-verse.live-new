            ...
            <div className="w-full md:w-40 bg-[#0f0f0f] border-b md:border-b-0 md:border-r border-[#222] flex md:flex-col shrink-0 overflow-x-auto md:overflow-visible">
                 ...
                 {isBuyable && !isLocked && (
                    <button 
                        ...
                        className={`flex items-center gap-2 px-4 py-3 text-[10px] font-bold whitespace-nowrap ${tab === 'PAYMENT' ? 'bg-[#1a1a1a] text-agent-green border-l-2 border-agent-green' : 'text-gray-500'}`}
                    >
                 ...
                 <button 
                    ...
                    className={`flex items-center gap-2 px-4 py-3 text-[10px] font-medium whitespace-nowrap ${tab === 'MANIFEST' ? 'bg-[#1a1a1a] text-white border-l-2 border-agent-green' : 'text-gray-500'}`}
                 >
                 ...
                 {!isLocked && !isBuyable && (
                    <button 
                        onClick={() => setTab('API')} 
                        className={`flex items-center gap-2 px-4 py-3 text-[10px] font-medium whitespace-nowrap ${tab === 'API' ? 'bg-[#1a1a1a] text-white border-l-2 border-agent-green' : 'text-gray-500'}`}
                    >
                ...
                {tab === 'PAYMENT' && !isLocked && (
                    <div className="space-y-6">
                        <div className="bg-gradient-to-r from-green-900/10 to-blue-900/10 border border-green-900/30 rounded p-4">
                            <h3 className="text-agent-green font-mono font-bold text-xs mb-2 flex items-center gap-2">
